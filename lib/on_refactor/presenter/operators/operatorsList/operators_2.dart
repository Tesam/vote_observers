...
import 'package:vote_observers/on_refactor/presenter/operators/operatorsList/operators_provider_2.dart';
...
class Operators2 extends StatefulWidget {
  const Operators2({Key? key}) : super(key: key);

  @override
  _Operators2State createState() => _Operators2State();
}

class _Operators2State extends State<Operators2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: MyTheme.background,
      body: Consumer<OperatorsProvider2>(
